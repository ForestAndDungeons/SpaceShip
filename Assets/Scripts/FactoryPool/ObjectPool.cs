...
//Cuando yo hago un new ObjectPool voy a tener que setear de que tipo va a ser
//Por ejemplo: new ObjectPool<Bullets>();
public class ObjectPool<T>
{
    ...
    //Cada vez que yo haga un new ObjectPool para crear un pool, voy a tener que pasarle estos parametros obligatoriamente (menos los ultimos 2)
    ...
    public T GetObject()
    {
        T result = default(T); //Creo una referencia default del tipo de objeto a devolver
        ...
        else if (_isDynamic) //Sino si es dinamico
        {
